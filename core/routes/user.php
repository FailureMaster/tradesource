...
Route::namespace('User\Auth')->name('user.')->middleware('country.blacklist')->group(function () {
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('OrderController')->group(function () {
                Route::name('order.')->prefix('order')->group(function () {
                    ...
                    Route::post('close-all-orders', 'closeAllOrders')->name('close-all-orders');

                    Route::post('stop-lost}', 'saveStopLoss')->name('stop.loss');
                    Route::post('take-profit', 'saveTakeProfit')->name('take.profit');
                });
