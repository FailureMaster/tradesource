...
Route::namespace('Auth')->withoutMiddleware([LanguageMiddleware::class])->group(function () {
...
Route::middleware('admin')->withoutMiddleware([LanguageMiddleware::class])->group(function () {
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::post('transaction/{transaction}/hide', 'hideTransaction')->name('transaction.hide');
    });
