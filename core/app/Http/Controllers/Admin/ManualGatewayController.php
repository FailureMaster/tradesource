...
class ManualGatewayController extends Controller
{
    public function index(Request $request)
    {
        ...
        $gateways = Gateway::with('singleCurrency')->manual()->orderBy('id','desc')->paginate($per_page);
        return view('admin.gateways.manual.list', compact('pageTitle', 'gateways', 'per_page'));
    }
