...
class WithdrawMethodController extends Controller
{
    public function methods(Request $request)
    {
        ...
        $methods = WithdrawMethod::orderBy('name')->orderBy('id')->paginate($per_page);
        return view('admin.withdraw.index', compact('pageTitle', 'methods', 'per_page'));
    }
