...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        // $previousUser   = $user_data->where('id', '>', $id)->sortBy('id')->first() ?? null;
        // $nextUser       = $user_data->where('id', '<', $id)->first() ?? null;

        // $previousUser = User::where('id', '>', $id)->orderBy('id', 'asc')->first() ?? null;
