            ...
            <form action="" method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Auth Redirection')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, authentication will redirect to the dashboard; otherwise, it will redirect to the trade room')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="auth_redirect" @if($general->auth_redirect) checked @endif>
                            </div>
                        </li>
                        
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Allow Demo Account')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, new user\'s account type will be demo account.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="allows_demo_account" @if($general->allows_demo_account) checked @endif>
                            </div>
                        </li>
                        
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Dashboard')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, dashboard button will be shown in trade room.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="dashboard" @if($general->dashboard) checked @endif>
                            </div>
                        </li>
                        
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Withdraw Money')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, withdraw money section will be shown in user dashboard .')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="withdraw_money" @if($general->withdraw_money) checked @endif>
                            </div>
                        </li>
                        
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('IP Address Checker')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, it will check the registered ip address against admin users.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="ip_address_check" @if($general->ip_address_check) checked @endif>
                            </div>
                        </li>
                    </ul>
                </div>
