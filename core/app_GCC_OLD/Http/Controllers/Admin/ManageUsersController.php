...
class ManageUsersController extends Controller
{
    ...
    {
        $pageTitle = 'All Leads';
        return $this->userList($request, $pageTitle, 'inactive', 'leads');
    }
                ...
                $user = User::create(
                    array_merge(
                        [
                            ...
                            'kv' => 1,
                            'profile_complete' => 1,
                            'account_type' => allowsDemoAccount() ? 'demo' : 'real',
                        ],
    ...
    public function import(Request $request)
    {
        ...
        $filePath = 'public/leads-to-be-import.csv';
        ...
        foreach ($lines as $key => $line) {
            ...
            $validator = Validator::make($data, [
                '0' => 'required|string',
                '1' => 'required|string',
                '2' => 'required|string|email|unique:users,email',
                '3' => 'required',
                '4' => 'required|in:' . $countryCodes,
                '5' => 'required|in:' . $countries
            ]);
