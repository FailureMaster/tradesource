...
class LoginController extends Controller
{
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        foreach ($languageCodes as $languageCode) {
            ...
            if ($language) {
                $countryNames = $language->languageCountries()
                ...
                if (in_array(strtolower($userLogin->country), $countryNames)) {
                    session()->put('lang', $languageCode);
                    app()->setLocale(session('lang', $languageCode));
                    break;
                }
            }
        }
        ...
        if ($general->auth_redirect) {
            return to_route('user.home');
        }
        return to_route('trade');
    }
