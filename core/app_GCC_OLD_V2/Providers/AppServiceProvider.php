...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        view()->composer([$activeTemplate . 'partials.header', $activeTemplate . 'partials.user_topbar', $activeTemplate . 'user.auth.login', $activeTemplate . 'user.auth.register'], function ($view) {
            $view->with([
