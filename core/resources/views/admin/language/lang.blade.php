            ...
            <div class="card b-radius--10 ">
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table" id="languageTbl">
                            <thead>
                            <tr>
                                <th>@lang('Name')</th>
                                <th>@lang('Code')</th>
                                ...
                                <tr>
                                    <td>
                                        <div class="user d-flex">
                                            ...
                                            <span class="name" style="width: 100px">{{__(@$item->name)}}</span>
                                        </div>
                                   </td>
                                    ...
                                    <td class="">
                                            ...
                                            @if ($item->code != 'en')
                                                <a href="{{route('admin.language.setting', $item->id)}}" class="btn btn-sm btn-outline--primary">
                                                    <i class="la la-cog"></i> @lang('Settings')
                                                </a>
                                            @endif
