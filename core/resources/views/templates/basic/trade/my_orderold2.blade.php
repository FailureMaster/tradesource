...
$(document).ready(function() {
    ...
    function closeOrdersBasedOnSLTP(response) {
        ...
        response.orders.forEach((order, index) => {
            ...
            if (Number(formatWithPrecision(parseFloat(order.stop_loss))) == Number(formatWithPrecision(current_price)) ||
                Number(formatWithPrecision(parseFloat(order.take_profit))) == Number(formatWithPrecision(current_price))) {
