    ...
    <div class="buy-sell__price pt-1 pb-1">
        ...
        <div class="input--group group-two @if(App::getLocale() == 'ar') text-end @endif">
            ...
            <label for="id_label_single" class="@if(is_mobile()) d-flex justify-content-between @endif">
                ...
                <select id="lot-size-select" class="form--control style-three lot-size-select" name="amount"  style="height: 60px; height: 100%; @if(is_mobile()) min-width: 70% !important @endif" onchange="updateLotValues(this)">
