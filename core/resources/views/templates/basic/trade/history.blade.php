            ...
            return `
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Stop Loss: ${order.stop_loss ? formatWithPrecision(order.stop_loss) : '-'}</li>
                        <li class="list-group-item">Take Profit: ${order.take_profit ? formatWithPrecision(order.take_profit) : '-'}</li>
